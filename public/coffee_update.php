...
//バリデーション処理
$validate = UserLogic::dataValidate2($coffee);
//エスケープ処理
$clean = html($coffee);
        ...
        <div class="post_wrapper">
            ...
            <div class="post_form">
                ...
                <form class="post_form" action="post_confirm.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php if (!empty($clean['id'])) {
                                                                echo $clean['id'];
                                                            } ?>">
                        ...
                        <div class="c_memo_container">
                            ...
                            <div class="form_item">
                                ...
                                <p>名　称<span style="color: red;">*</span>　：
                                    <input type="text" name="c_name" id="" style="height: 30px;" value="<?php if (!empty($clean['name'])) {
                                                                                                            echo $clean['name'];
                                                                                                        } ?>">
                                </p>
                ...
                <input type="hidden" name="id" value="<?php if (!empty($clean['id'])) {
                    ...
                    <div class="post_container">
                        ...
                        <div class="c_memo_container">
                            ...
                            <div class="form_item">
                                <p>名　称　：
                                    <input type="hidden" name="name" value="<?php echo $clean["name"] ?>"><?php echo $clean["name"]; ?>
                                </p>
                                <p>購入店　：
                    ...
                    <a style="color: white; background-color: yellowgreen; padding: 3px 70px; opacity: 0.8; border-radius: 4px;" class="back_btn" href="#" onclick="history.back(); return false;">戻　る</a>
                    <input class="reg_btn" style="width: 200px; height: 30px; margin:10px" type="submit" name="update_coffee" id="" formaction="mypage.php" value="登　録">
